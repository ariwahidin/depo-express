...
<head>
    ...
    <title>{{ $title ?? 'Depo Inventory' }}</title>
...
<body>
    ...
    <!-- <script data-navigate-once src="{{ asset('/') }}assets/vendor/libs/sweetalert2/sweetalert2.js"></script> -->
    <!-- <script data-navigate-once src="{{ asset('/') }}assets/js/extended-ui-sweetalert2.js"></script> -->


    <!-- Page JS -->
    <script data-navigate-once src="{{ asset('/') }}assets/vendor/libs/block-ui/block-ui.js"></script>
    <script data-navigate-once src="{{ asset('/') }}assets/js/extended-ui-blockui.js"></script>
