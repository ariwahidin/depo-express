    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div class="row">
                ...
                <div class="col-md-2 mt-2">
                    <button type="button" class="btn btn-info float-end" wire:click="$dispatch('reloadSupplier')">
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item waves-effect" href="javascript:void(0);" wire:click="$dispatch('editSupplier', {supplier_id: {{ $supplier->id }}})"><i class="ti ti-pencil me-1"></i> Edit</a>
                                    <a class="dropdown-item waves-effect" href="javascript:void(0);" wire:click="$dispatch('showDeleteModalNow', {id : {{ $supplier->id }}})"><i class="ti ti-trash me-1"></i> Delete</a>
                                </div>
                            </div>
                        </td>
                    </tr>
